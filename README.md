...
`-beta x` | Number between 0 and 1, defines the trade-off between sensitivity and specificity for aberration calling. If e.g. beta=0.1, (non-log2) ratios between 0.95 and 1.05 (1.05 - 0.95 = 0.1) are interpreted as non-aberrant (default: x=0.05)  
